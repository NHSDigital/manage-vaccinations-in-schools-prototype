  ...
  readForm(type) {
    return (request, response, next) => {
      ...
      const homeVaccinationJourney = {
        ...
        ...(vaccination?.programme?.type === ProgrammeType.Flu
          ? {
              [`/${vaccination_uuid}/${type}/protocol`]: {}
            }
          : {}),
        [`/${vaccination_uuid}/${type}/administered-at`]: {},
        [`/${vaccination_uuid}/${type}/check-answers`]: {}
      ...
      let givenJourney
      if (vaccination.locationType === LocationType.Home) {
        givenJourney = homeVaccinationJourney
      } else if (vaccination.outcome === VaccinationOutcome.AlreadyVaccinated) {
        givenJourney = previousVaccinationJourney
      } else {
        givenJourney = newVaccinationJourney
      }
