...
// TODO
router.all('/:session_preset_slug/:booking_uuid/new/:appointment_uuid/:view', bookIntoClinic.readForm)
router.all('/:session_preset_slug/:booking_uuid/new/:view', bookIntoClinic.readForm)

router.get('/:session_preset_slug/:booking_uuid/new/:appointment_uuid/:view', bookIntoClinic.showForm)
...
router.post('/:session_preset_slug/:booking_uuid/new/:appointment_uuid/:view', bookIntoClinic.updateForm)
