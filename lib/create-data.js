...
for (let booking of Object.values(context.clinicBookings)) {
  ...
  const firstAppointment = generateClinicAppointment(booking.uuid, null, context)
  ...
  for (let i = 0; i < additionalAppointmentsCount; i++) {
    ...
    const nextAppointment = generateClinicAppointment(booking.uuid, firstAppointment.parent, context)
